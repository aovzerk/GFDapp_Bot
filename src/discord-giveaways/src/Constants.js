...
exports.GiveawayMessages = {
    ...
    endedAt: 'Закончится',
    hostedBy: 'Запустил: {this.hostedBy}'
};
...
exports.PauseOptions = {
    isPaused: false,
    content: '⚠️ **РОЗЫГРЫШ ОСТАНОВЛЕН !** ⚠️',
    unPauseAfter: null,
    embedColor: '#FFFF00',
...
exports.GiveawayRerollOptions = {
    winnerCount: null,
    messages: {
        congrat: ':tada: Новый победитель/и: {winners}! Поздравляем, вы выйграли **{this.prize}**!\n{this.messageURL}',
        error: 'Нет победителей, ошибка розыгрыша'
    }
};
