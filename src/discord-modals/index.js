...
module.exports = (client) => {
	...
	if (client.callback_modals) {
		client.ws.removeListener("INTERACTION_CREATE", client.callback_modals);
	}

	// We receive the 'INTERACTION_CREATE' event from WebSocket.
	client.callback_modals = (data) => {
	...
	client.ws.on("INTERACTION_CREATE", client.callback_modals);
